return { 
    {
        ...
        build = ':TSUpdate',
        opts = {
            -- A list of parser names, or "all" (the listed parsers MUST always
            -- be installed)
            ...
            highlight = {
                ...
                -- of true it can also be a list of
                -- languages
...

    {
        ...
        opts = {
            ...
            mode = 'cursor',  -- Line used to calculate context. Choices: 'cursor', 'topline' Separator between context and content. Should be a single character string, like '-'. When separator is set, the context will only show up when there are at least 2 lines above cursorline.
            separator = nil,
